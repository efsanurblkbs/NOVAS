            ...
            {!selectedPost && !isEditing ? (
              (managementMode || allowWrite) ? (
                <motion.form key="write" initial={{opacity:0}} animate={{opacity:1}} exit={{opacity:0}} onSubmit={handleSubmit} className="flex-1 flex flex-col">
                 ...
                 <textarea className="flex-1 w-full mt-4 text-base md:text-xl leading-[40px] md:leading-[48px] border-none outline-none focus:ring-0 resize-none font-light text-slate-700 bg-transparent min-h-[300px] py-0 break-words" style={{backgroundImage: "linear-gradient(transparent, transparent 39px, #EADED7 39px)", backgroundSize: `100% ${window.innerWidth < 768 ? '40px' : '48px'}`}} placeholder="Bugün neler oldu?" value={newPost.desc} onChange={e=>setNewPost({...newPost, desc:e.target.value})} required/>
              ...
              <motion.div key="read" initial={{opacity:0}} animate={{opacity:1}} exit={{opacity:0}} className="flex-1 flex flex-col h-full min-h-0">
                 ...
                 <div className="flex-1 pb-10">
                   ...
                   <p className="text-base md:text-lg leading-[40px] md:leading-[48px] font-light text-slate-700 italic whitespace-pre-wrap px-2 py-0 break-words" style={{backgroundImage: "linear-gradient(transparent, transparent 39px, #EADED7 39px)", backgroundSize: `100% ${window.innerWidth < 768 ? '40px' : '48px'}`}}>
                     {selectedPost.desc}
                   </p>
                 </div>
              </motion.div>
              ...
              <motion.form key="edit" initial={{opacity:0}} animate={{opacity:1}} exit={{opacity:0}} onSubmit={handleSubmit} className="flex-1 flex flex-col h-full">
                 ...
                 <textarea className="flex-1 w-full mt-6 text-base md:text-xl leading-[40px] md:leading-[48px] border-none outline-none focus:ring-0 resize-none font-light text-slate-700 bg-transparent min-h-[300px] py-0 break-words" style={{backgroundImage: "linear-gradient(transparent, transparent 39px, #EADED7 39px)", backgroundSize: `100% ${window.innerWidth < 768 ? '40px' : '48px'}`}} value={newPost.desc} onChange={e=>setNewPost({...newPost, desc:e.target.value})} required/>
