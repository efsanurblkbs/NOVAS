                        ...
                        {u.lastDiaries && u.lastDiaries.length > 0 ? (
                          <div className="flex gap-2 h-20 items-center overflow-x-hidden">
                            {u.lastDiaries.map((diary, idx) => (
                              <div 
                                key={idx} 
                                className="w-14 h-18 shrink-0 rounded-xl p-2 flex flex-col justify-center items-center border border-white/40 shadow-sm transition-transform group-hover:scale-105"
